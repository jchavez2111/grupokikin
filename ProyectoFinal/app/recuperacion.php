...
$queryrec=mysqli_query($conex, "Select correo from usuario where dni='$usuarior'");
...
if ($nr == 1) {
    ...
    <body> 
    <h1 class='h1__form'>Código de Recuperación de la APP!</h1>
    ...
    echo '<div id="modalbig" class="modal__big">
            <div class="modal__error">
                ...
                <h3 class="h3__error">Por favor, verifica el DNI ingresado.</h3>
            </div>
            </div>';
}
