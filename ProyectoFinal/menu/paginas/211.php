                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12 grid-margin stretch-card" name="tablasdetalle">
                            <div class="card">
                                <div class="card-body">
                                    <center>
                                        <h4 class="card-title">Recepcionar Productos RequeridosN° RPR<input type="text "id="valor" value="<?php echo($id[0]);?>" disabled></input></h4>
                                    </center>
                                                ...
                                                <table class="table table">
                                                    ...
                                                    <tbody id="tabla_orden">
                                                        ...
                                                        foreach ($ordenpedido as $x) {
                                                            $var1 = "<tr><td>OPR$x[0]</td><td>$x[2]</td><td id='fila' class='text-danger'>Pendiente <i class='mdi mdi-alert-circle'></i></td><td><input id='txtindices' type='checkbox' id='$x[0]' onClick='imprimiendo(";
                                    ...
                                    <h4 class="card-title">Detalle de productos requeridos <h4 class="card-title" id="numeroorden">000</h4></h4>
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table">
                                    ...
                                    <br>
                                                <center><button id="btnguardartodo" class="btn btn-lg btn-primary btn-icon-text centrar"> Generar Recepción de Productos
                                                    </button></center>
                                                <br>
