...
<html lang="en">
    <head>
        ...
        <title>Generar Comprobante de Pago</title>
        <!-- plugins:css -->
    ...
    <body>
          ...
          AND c.idcolaborador='$usuario'";
                    ...
                    while ($mostrar = mysqli_fetch_array($resultado)) {
                        ...
                        <li class="nav-item menu-items">
                            <a href="<?php echo $mostrar['columna2'] ?>.php" class="nav-link" href="../index.html">
            ...
            <div class="container-fluid page-body-wrapper">
                ...
                <div class="main-panel">
                    ...
                    <div class="content-wrapper">
                        <div class="row">
                            <div class="page-header centrar">
                                <h1 class="page-title"> Pedidos Terminados</h1>
                            </div>
                            <!-- primera cabecera -->
                            <!-- Codigo Fechas y filtros -->
                            <?php
                            //VALORES INICIALES DE LA PÁGINA                            
                            include_once '../../menu/controlador/negocio.php';
                            $obj = new Negocio();
                            $listpedido = $obj->pedidoter();
                            ...
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title centrar">Pedidos Terminados</h4><br>                                        
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                                                        ...
                                                        <tbody id="tabla_orden">
                                                            <?php
                                                            foreach ($listpedido as $x) {
                                                                $var1 = "<tr><td>100$x[0]<td>$x[1]<td>$x[2]<td>$x[3]<td>$x[4] $x[5]<td><input id='txtindices' type='radio' name='optpedidosss' id='$x[0]'  onClick='imprimiendo(";
                                                                $var2 = ")' class='btn btn-outline-secondary btn-sm'></input></td>";
                            ...
                            <div class="col-lg-12 grid-margin stretch-card">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="card-title centrar">Detalle Pedido</h4>                                   
                                        <div class="card">
                                            <div class="card-body">
                                                <div class="table-responsive">
                                                    <table class="table table-hover">
                    ...
                    <br>
                    <center>
                        <button id="btnguardartodo"  onclick="guardarcomprobante()" class="btn btn-lg btn-primary btn-icon-text centrar"> Generar Comprobante de Pago
                        </button>
                    </center>
                    <br>


                    <button id="imprimir" Onclick="imprimir()" type="button" class="btn btn-lg btn-outline-primary  btn-icon-text">
                        <i class="mdi mdi-printer btn-icon-prepend"></i> Imprimir Comprobante de Pago</button>
                </div>
                </center>
            </div>
        ...
        <div class="modalconfi">
            ...
            <h1 class="whitemodal">¿Desea Registrar el Comprobante de Pago?</h1>
            <p class="whitemodal">
                Su comprobante se registrará luego de dar click en el botón aceptar
            </p>
