...
<body>
    <div class="container-scroller">
            ...
            <div class="main-panel">
                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        $lisPedidos = $obj->listapedidospagados();
                        $lisAyudantes = $obj->listarepartidores();
                        ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <center>
                                                <h4 class="card-title">Asignar Reparto</h4>
                                                <center>

                                                

                                                    <button class="accordion btn-block btn-lg btn-primary">Pedidos Listos para Entregar</button>
                                                                ...
                                                                <table class="table table">
                                                                    ...
                                                                    <tbody id="tabla_pedidos">
                                                                        ...
                                                                        foreach ($lisPedidos as $x) {
                                                                            echo "<tr><td>100$x[0]</td><td>$x[1]</td><td>$x[2]</td><td><div class='form-check form-check-muted m-0'><input id='pedido$x[0]' type='radio' name='optpedidossssss' Onclick='pedido($x[0])' class='form-check-input'>Seleccionar</div></td></tr>";
                                                                        }
                                                                        ?>
                                                                    </tbody>
                                                                </table>
                                                        ...
                                                        <table class="table table">
                                                            ...
                                                            <tbody id="tabla_ayudantes">
                                                                        ...
                                                                        foreach ($lisAyudantes as $x) {
                                                                            ...
                                                                            echo "<tr><td>$x[0]</td><td>$x[1] pedidos</td><td>$x[2]</td><td><div class='form-check form-check-muted m-0'><input id='mozo$x[0]'  type='radio' name='optrepartidores' Onclick='ayudante($x[0])' class='form-check-input'>Seleccionar</div></td></tr>";
                                                                        }
                                                                        ?>
                                                                    </tbody>
                                                        </table>
        ...
        <div class="modalconfi">
            ...
            <h1 class="whitemodal">¿Desea Asignar el Pedido?</h1>
            <p class="whitemodal">
                Su pedido se asignará al repartidor luego de dar click en el botón aceptar
            </p>
