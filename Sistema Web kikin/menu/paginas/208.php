            ...
            <div class="main-panel">
                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        $lisPedidos = $obj->listapedidospendientes();
                        $lisAyudantes = $obj->listaayudantescocina();   
                        ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <center>
                                                <h4 class="card-title">Asignar Pedido</h4>
                                                <center>

                                                

                                                    <button class="accordion btn-block btn-lg btn-primary">Pedidos Pendientes</button>
                                                                ...
                                                                <table class="table table">
                                                                    ...
                                                                    <tbody id="tabla_pedidos">
                                                                        ...
                                                                        foreach ($lisPedidos as $x) {
                                                                            ...
                                                                            echo "<td>$x[2]</td><td>$x[3]</td><td><div class='form-check form-check-muted m-0'><input id='platoid$x[0]' type='radio' name='optpedidos' Onclick='pedido($x[0])' class='form-check-input'>Seleccionar</div></td></tr>";
                                                                        }
                                                                        ?>
                                                                    </tbody>
                                                                </table>
                                                    ...
                                                    <button class="btn-block btn-lg btn-primary">Detalle Pedido</button>
                                                    <div class="card">
                                                        <div class="card-body">
                                                            <div class="table-responsive">
                                                                <center>
                                                    ...
                                                    <center>
                                                        <h4 class="card-title">Ayudantes de Cocina</h4>
                                                    </center><br>
                                                    <div class="table-responsive">
                                                        <table class="table table">
                                                            <thead>
                                                            ...
                                                            <tbody id="tabla_ayudantes">
                                                                        ...
                                                                        foreach ($lisAyudantes as $x) {
                                                                            ...
                                                                            echo "<tr><td>$x[0]</td><td>$x[1] Platos</td><td>$x[2]</td><td><div class='form-check form-check-muted m-0'><input id='ayudanteid$x[0]' type='radio' name='optradio' Onclick='ayudante($x[0])' class='form-check-input'>Seleccionar</div></td></tr>";
                                                                        }
                                                                        ?>
                                                                    </tbody>
                                                        </table>
