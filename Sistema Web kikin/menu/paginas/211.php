...
<body>
    <div class="container-scroller">
            ...
            <div class="main-panel">
                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        $consulta = "SELECT MAX(fechaCreacion) as columna,MIN(fechaCreacion) as columna2 FROM `ordenpedidoproductorequeridos`;";
                        $resultado = mysqli_query($conex, $consulta);
                        while ($mostrar = mysqli_fetch_array($resultado)) {
                        ...
                        $ordenpedido = $obj->lisOrdenFiltro($minfecha, $maxfecha);                 
                        ?>
                        ...
                        <div class="col-lg-12 grid-margin stretch-card" name="tablasdetalle">
                            <div class="card">
                                <div class="card-body">
                                    <center>
                                        <h4 class="card-title">Recepcionar Productos Requeridos N° RPR0<?php echo($id[0]);?></input></h4>
                                    </center>

                                    <button class="accordion btn-block btn-lg btn-primary">Ver Ordenes de Productos Requeridos</button>
                                        ...
                                        <div class="col-md-4 d-flex align-items-center">
                                            <div class="d-flex flex-row align-items-center">
                                                <button id="button1" type="button" class="btn btn-md btn-info  btn-icon-text">
                                                    <i class="mdi mdi-filter btn-icon-prepend"></i> Buscar Orden de Productos </button>
                                            </div>
                                        </div>
                                    </div><br>
                                                ...
                                                <table class="table table">
                                                    ...
                                                    <tbody id="tabla_orden">
                                                        ...
                                                        foreach ($ordenpedido as $x) {
                                                            $var1 = "<tr><td>OPR$x[0]</td><td>$x[2]</td><td id='fila' class='text-danger'>Pendiente <i class='mdi mdi-alert-circle'></i></td><td><input id='txtindices' type='radio' name='ordenpedido' onClick='imprimiendo(";
                                    ...
                                    <h4 class="card-title" id="numeroorden">Selecciona una orden</h4>
                                    <div class="card">
                                        <div class="card-body">
                                            <div class="table-responsive">
                                                <table class="table">
                                    ...
                                    <br>
                                                <center><button onclick="actualizar()" class="btn btn-lg btn-primary btn-icon-text centrar"> Generar Recepción de Productos
                                                    </button></center>
                                                <br>
                                    ...
                                    <div class="template-demo d-flex justify-content-between flex-nowrap">
                                        ...
                                        <button Onclick="imprimir(<?php echo($id[0]);?>)" type="button" class="btn btn-lg btn-outline-primary  btn-icon-text">
        ...
        <div class="modalconfi">
            ...
            <h1 class="whitemodal">¿Desea Recepcionar la Orden de Productos Requeridos?</h1>
            <p class="whitemodal">
                Su recepción se generará luego de dar click en el botón aceptar.
            </p>
