...
<body>
    <div class="container-scroller">
                        ...
                        <div id="miModal" class="col-lg-12 grid-margin stretch-card modal" name="tablasdetalle">
                            <div class="card modal-contenido">
                                <div class="card-body">
                                                    ...
                                                    <tbody id="tabla_productos">
                                                        ...
                                                        foreach ($lisEnvases as $x) {
                                                            ...
                                                            if ($x[3] == 0) {
                                                                ...
                                                                echo "$x[3]</td><td><div class='form-check form-check-muted m-0'><input id='txtindices' type='checkbox' class='form-check-input'>Seleccionar</div></td></tr>";
                                                            }
                                                        }
                                                        ?>
                                                    </tbody>
                                    ...
                                    <br>
                                    <center><a id="btnsalirmodel" href="#" class="btn btn-lg btn-primary btn-icon-text centrar"> Agregar
                                        </a></center><br>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <center>
                                                <h4 class="card-title">Detalle plato del Día: <?php echo date("d/m/Y"); ?></h4>
                                                <center>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 d-flex align-items-center">
                                                            <div class="d-flex flex-row align-items-center">
                                                            <h4 style="margin: auto;">Cantidad:  </h4>
                                                            <input id='txtcantplatos' type='number' placeholder='1'>
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 d-flex align-items-center">
                                                            <div class="d-flex flex-row align-items-center">
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        <br>
                                                        <center><button onclick="presionbuttontres()" class="btn btn-lg btn-primary btn-icon-text centrar">Generar Plato del día
                                                            </button></center>
                                                        <br>
                                                    </div>
                                        </div>
                                    ...
                                    <div class="template-demo d-flex justify-content-between flex-nowrap">
                                        ...
                                        <button onclick="imprimirrep()" target="_blank" type="button" class="btn btn-lg btn-outline-primary  btn-icon-text">
        ...
        <div class="modalconfi">
            ...
            <h1 class="whitemodal">¿Desea Generar los ingredientes para el plato?</h1>
            <p class="whitemodal">
                Se generará luego de dar click en el botón aceptar.
            </p>
