...
<head>
    ...
    <title>Recepcionar Pedidos</title>
    <!-- plugins:css -->
...
<body>
    <div class="container-scroller">
            ...
            <div class="main-panel">
                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        $queryrec = mysqli_query($conex, "SELECT r.idRepartidor FROM colaborador c, persona p, repartidor r WHERE c.dni=p.dni AND p.dni=r.dni AND c.idcolaborador='$usuario'");
                      $idc= $queryrec->fetch_array(MYSQLI_NUM);

                        // VALORES PARA EL FILTRO
                        $lisAyudantes = $obj->listapedidosfinalizar($idc[0]);
                        ?>
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <center>
                                                <h4 class="card-title">Recepcionar Pedido</h4>
                                                <center>                                                    
                                                        ...
                                                        <table class="table table">
                                                            ...
                                                            <tbody id="tabla_ayudantes">
                                                                        ...
                                                                        foreach ($lisAyudantes as $x) {
                                                                            ...
                                                                            echo "<tr><td>$x[0]</td><td>$x[1]</td><td>$x[2]</td><td>S/ $x[3]</td><td><select name='select' id='estado' onchange='estado()'>
                                                                            <option value='0'>Seleccione una opcion</option>
                                                                            <option value='6'>Recibido</option>
                                                                            <option value='7'>No Recibido</option>
                                                                          </select>
                                                                          </td><td><div class='form-check form-check-muted m-0'><input id='mozo$x[0]' 
                                                                            type='radio' name='optpediiii' Onclick='ayudante($x[0])' class='form-check-input'>Seleccionar</div></td></tr>";
                                                                        }
                                                                        ?>
                                                                    </tbody>
                                                        </table>
                                                        <h5>Comentarios de la entrega:</h5>
                                                        <textarea id="comentario" name="comentarios" rows="5" cols="40" placeholder="Escribe aquí tus comentarios"></textarea>
                                                        <br><br>
                                                        <center><button id="guardartodo" Onclick="presionbuttontres()" class="btn btn-lg btn-primary btn-icon-text centrar">Recepcionar Pedido
                                                            </button></center>
                                                        <br>
                                                    </div>
                                        </div>
        ...
        <div class="modalconfi">
            ...
            <h1 class="whitemodal">¿Desea Registrar la Recepcion?</h1>
            <p class="whitemodal">
                La recepción se registrará luego de dar click en el botón aceptar
            </p>
