...
<body>
    <div class="container-scroller">
                                                ...
                                                <table class="table table">
                                                    ...
                                                    <tbody id="tabla_orden">
                                                        ...
                                                        foreach ($ordenpedido as $x) {
                                                            $var1 = "<tr><td>OPR$x[0]</td><td>$x[1]</td><td>$x[2]</td><td>$x[3]</td><td><input id='txtindices' type='radio' name='ordenes' id='$x[0]' onClick='imprimiendo(";
        ...
        <div class="modalconfi">
            ...
            <h1 class="whitemodal">¿Desea Pagar al Proveedor?</h1>
            <p class="whitemodal">
                Su su pago se realizará luego de dar click en el botón aceptar.
            </p>
