...
<body>
                            ...
                            <div class="card">
                                <div class="card-body">
                                                ...
                                                <table class="table table">
                                                    ...
                                                    <tbody id="tabla_orden">
                                                        ...
                                                        foreach ($ordenpedido as $x) {
                                                            $var1 = "<tr><td>10000$x[0]</td><td>$x[1]</td><td id='fila' class='text-danger'>Recepcionado <i class='mdi mdi-alert-circle'></i></td><td><input id='txtindices' type='radio' name='ordenprodr' id='$x[2]' onClick='imprimiendo(";
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <center>
                                                <h4 class="card-title">Generar Orden de Pago de Prod. Requeridos N° OPP<?php echo ($id[0]); ?></h4><br>
                                            ...
                                            <form class="forms-sample" action="../controlador/RegistrarordendePagoProRe.php?numpago=<?php echo ($id[0]); ?>" method="post" enctype="multipart/form-data" id="formpago">
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input step=".01" onChange="calculo();" name="monto" id="monto" type="number" class="form-control" id="exampleInputEmail3" placeholder="Monto">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail3">IGV</label>
                                                    <input  step=".01" name="igv" id="igv" type="number" class="form-control" id="exampleInputEmail3" placeholder="IGV">
                                                </div>
                                                <div class="form-group">
                                                    <label for="exampleInputEmail3">Total</label>
                                                    <input step=".01" name="montototal" id="montototal" type="number" class="form-control" id="exampleInputEmail3" placeholder="Total">
                                                </div>
                                                <div class="form-group">
                                                ...
                                                <center><input Onclick="imprimir()"  name="enviarform" id="btnorden" type="submit" id="btnguardartodo" class="btn btn-lg btn-primary btn-icon-text centrar" value="Generar Orden de Pago"></input></center>
    ...
    <script>
        function calculo() {
            ...
            $("input[name=montototal]").val(parseInt(monto) + parseInt(igv));
        }
    </script>
    <!-- plugins:js -->
