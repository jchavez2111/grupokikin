...
<head>
    ...
    <title>Generar Pedidos en Local</title>
    <!-- plugins:css -->
...
<body>
    <div class="container-scroller">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <center>
                                                <h4 class="card-title">Generar Pedido: N°000<?php echo ($idped[0]); ?></h4>
                                                <center>

                                                    <button class="accordion btn-block btn-lg btn-primary">Mesas</button>
                                                                ...
                                                                <table class="table table">
                                                                    ...
                                                                    <tbody id="tabla_productos">
                                                                        ...
                                                                        foreach ($lisMesa as $x) {
                                                                            echo "<tr><td>$x[0]</td><td>$x[1]</td><td><div class='form-check form-check-muted m-0'><input id='mesaid$x[0]' type='checkbox' Onclick='idmesa($x[0])' class='form-check-input'>Seleccionar</div></td></tr>";
                                                                        }
                                                                        ?>
                                                                    </tbody>
                                                                </table>
                                                    ...
                                                    <center>
                                                        <h4 class="card-title">Platos Seleccionados</h4>
                                                        <a id="btninventario" href="#miModal" type="button" class="btn btn-primary btn-icon-text">
                                                            <i class="mdi mdi-magnify btn-icon-prepend"></i> Buscar Platos </a>
                                                    </center><br>
                                                    <div class="table-responsive">
                                                        <table class="table table">
                                                            <thead>
                                                        ...
                                                        <br>
                                                        <center><button id="guardartodo" Onclick="presionbuttontres()" class="btn btn-lg btn-primary btn-icon-text centrar">Generar Pedido en Local
                                                            </button></center>
                                                        <br>
                                                    </div>
                                        </div>
                                    ...
                                    <div id="miModal" class="col-lg-12 grid-margin stretch-card modal" name="tablasdetalle">
                                        <div class="card modal-contenido">
                                            <div class="card-body">
                                                <center>
                                                    <h4 class="card-title">Carta</h4>
                                                </center>
                                                Nombre del Plato: <input id="myInput" type="text" placeholder="Buscar..">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="table-responsive">
                                                            <table class="table table">
                                                                ...
                                                                <tbody id="tabla_orden">
                                                                    <?php
                                                                    foreach ($lisPlatos as $x) {
                                                                        echo "<tr><td>$x[0]</td><td>$x[1]</td><td>$x[2]</td><td>";
                                                                        if ($x[4] == 0) {
                                                                            echo "<label class='badge badge-danger'>Agotado</label></td><td> - </td><td> -</><tr>";
                                                                        } else {
                                                                            echo "$x[3]</td><td>$x[4]</td><td><div class='form-check form-check-muted m-0'><input id='txtindices' type='checkbox' class='form-check-input'>Seleccionar</div></td></tr>";
                                                                        }
                                                                    }
                                                                    ?>
                                                                </tbody>
                                                ...
                                                <br>
                                                <center><a id="btnsalirmodel" href="#" class="btn btn-lg btn-primary btn-icon-text centrar"> Seleccionar Platos
                                                    </a></center><br>
        ...
        <div class="modalconfi">
            ...
            <h1 class="whitemodal">¿Desea crear un Pedido?</h1>
            <p class="whitemodal">
                Su pedido se creará luego de dar click en el botón aceptar
            </p>
