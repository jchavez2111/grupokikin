                                                ...
                                                <center>
                                                    ...
                                                    <div class="card">
                                                        <div class="card-body">
                                                            ...
                                                            <?php
                                                            $date=date("Y-m-d");
                                                            $max=strtotime($date."+ 14 days");
                                                            ?>
                                                                        <input id="vencimiento" type='date' name='optpedidos'class='form-check-input'  min="<?php echo(date("Y-m-d"));?>" max="<?php echo date("Y-m-d",$max);?>"><br><br>
