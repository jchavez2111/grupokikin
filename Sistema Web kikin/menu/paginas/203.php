...
<body>
    <div class="container-scroller">
            ...
            <div class="main-panel">
                ...
                <div class="content-wrapper">
                    <div class="row">
                        ...
                        $lisMesa = $obj->pedidosparareclamo();
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <center>
                                                <h4 class="card-title">Pedidos Pagados del día</h4>
                                                <center>
                                                                ...
                                                                <table class="table table">
                                                                    ...
                                                                    <tbody id="tabla_productos">
                                                                        ...
                                                                        foreach ($lisMesa as $x) {
                                                                            echo "<tr><td>P000$x[0]</td><td>$x[1]</td><td>$x[2]</td><td>$x[3]</td><td>$x[4]</td><td>S/ $x[5]</td><td><div class='form-check form-check-muted m-0'><input type='radio' name='optpedidos' Onclick='idpedido($x[0])' class='form-check-input'>Seleccionar</div></td></tr>";
                                                                        }
                                                                        ?>
                                                                    </tbody>
                                                                </table>
                                                    ...
                                                    <div class="table-responsive">
                                                                <h5 style="margin: auto;">Selecciona Tipo de Reclamo:  </h5>
                                                                <select id="platos" name="platos" onchange='estado()'>
                                                                <option value='0'>Selecciona</option>
                                                                <option value='1'>Pedido Dañado</option>
                                                                <option value='2'>Pedido Incompleto</option>
                                                                <option value='3'>Pedido Incorrecto</option>
                                                                <option value='4'>Cobro Incorrecto</option>
                                                                </select><br><br>
                                                        ...
                                                        <br><br>
                                                        <center><button id="guardartodo" Onclick=" generarreclamo()" class="btn btn-lg btn-primary btn-icon-text centrar">Generar Documento de Reclamo
                                                            </button></center>
                                                        <br>
                                                    </div>
                                        </div>
        ...
        <div class="modalconfi">
            ...
            <h1 class="whitemodal">¿Desea crear un Reclamo?</h1>
            <p class="whitemodal">
                El reclamo se creará luego de dar click en el botón aceptar
            </p>
