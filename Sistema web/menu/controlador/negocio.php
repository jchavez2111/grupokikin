...
class Negocio
{
    ...
    function crearordenprodreq($id)
    {
        $vec = array();
        $con = new Conexion();
        $sql = "insert into ordenpedidoproductorequeridos values($id,'pendiente',CURDATE())";
        $res = mysqli_query($con->abre(), $sql) or
            die(mysqli_error($con->abre()));
    }
    ...
    { //lista especialiadades
        $vec = array();
        $con = new Conexion();
        $sql = "insert into detalleordenprodrequeridos values($id,$idprod,$cant,'pendiente')";
        $res = mysqli_query($con->abre(), $sql) or
            die(mysqli_error($con->abre()));
    }
    ...
    function grabarRecepcion($id, $idprod, $cant)
    {
        $vec = array();
        $con = new Conexion();
        $sql = "insert into detallerecepcionproductosrequeridos values($id,$idprod,$cant,CURDATE())";
        $res = mysqli_query($con->abre(), $sql) or
            die(mysqli_error($con->abre()));
    }

    function actualizarProducto($id, $cant)
    {
        $vec = array();
        $con = new Conexion();
        $sql = "update inventario set stock=stock+'$cant' where idProductos='$id'";
    ...
    function actualizarestadoorden($id,$prod)
    {
        $vec = array();
        $con = new Conexion();
        $sql = "update detalleordenprodrequeridos set estadoproducto='recibido' where idProductos='$prod' and idOrdenPedidoProdR='$id'";
        $res = mysqli_query($con->abre(), $sql) or
            die(mysqli_error($con->abre()));
    }
    ...
    function crearordenrecepcion($id)
    {
        $vec = array();
        $con = new Conexion();
        $sql = "insert into recepcionproductosrequeridos values($id,CURDATE(),'Recepcionado')";
        $res = mysqli_query($con->abre(), $sql) or
            die(mysqli_error($con->abre()));
    }
    ...
    function actualizarorden($id)
    {
        $vec = array();
        $con = new Conexion();
        $sql = "update ordenpedidoproductorequeridos set estado='recepcionado' where idOrdendePedidoProdr='$id'";
        $res = mysqli_query($con->abre(), $sql) or
            die(mysqli_error($con->abre()));
    }
    ...
    function actualizarOrdenPago($id)
    {
        $vec = array();
        $con = new Conexion();
        $sql = "update ordendepagoproductosrequeridos set estado='pagado' where idOrdendePago='$id'";
        $res = mysqli_query($con->abre(), $sql) or
            die(mysqli_error($con->abre()));
    }
    ...
    function insertarNota($nc,$reclamo,$monto)
    {
        $vec = array();
        $con = new Conexion();
        $sql = "insert into notacredito values($nc,$reclamo,$monto,CURDATE(),DATE_ADD(CURDATE(),INTERVAL 14 DAY))";
        $res = mysqli_query($con->abre(), $sql) or
            die(mysqli_error($con->abre()));
    }
