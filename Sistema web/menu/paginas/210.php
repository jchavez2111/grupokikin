                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            ...
                                            <div class="template-demo d-flex justify-content-between flex-nowrap">
                                                <h4 class="card-title centrar">Lista de pedidos de productos requeridos: N° OPR<input type="text "id="valor" value="<?php echo($id[0]);?>" disabled></input></h4>
                                            ...
                                            <div class="table-responsive">
                                                ...
                                                <br>
                                                <center><button id="guardartodo" class="btn btn-lg btn-primary btn-icon-text centrar"> Generar Lista de Productos Requeridos
                                                    </button></center>
                                                <br>
                                            </div>
                                        </div>
                                    ...
                                    <div class="template-demo d-flex justify-content-between flex-nowrap">
                                        ...
                                        <button id="imprimirorden" type="button" class="btn btn-lg btn-outline-primary  btn-icon-text">
