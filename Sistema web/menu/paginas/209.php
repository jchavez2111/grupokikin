                            ...
                            <div class="card">
                                <div class="card-body">
                                                ...
                                                <center>
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-4 d-flex align-items-center">
                                                            ...
                                                            <input id='txtcantplatos' type='number' placeholder='1' min='1' max="10">
                                                            </div>
                                                        </div>
                                                        <div class="col-md-4 d-flex align-items-center">
                                                            <div class="d-flex flex-row align-items-center">
                                                    ...
                                                    <div class="table-responsive">
                                                        ...
                                                        <br>
                                                        <center><button id="guardartodo" class="btn btn-lg btn-primary btn-icon-text centrar">Generar Plato del día
                                                            </button></center>
                                                        <br>
                                                    </div>
                                        </div>
                                    ...
                                    <div class="template-demo d-flex justify-content-between flex-nowrap">
                                        ...
                                        <button id="imprimirdetalleplato" target="_blank" type="button" class="btn btn-lg btn-outline-primary  btn-icon-text">
