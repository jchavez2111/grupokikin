...
<head>
    ...
    <title>Generar Evaluación de Reclamo</title>
    <!-- plugins:css -->
    ...
    <div class="container-scroller">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    ...
                                    <div class="card">
                                        <div class="card-body">
                                            <center>
                                                <h4 class="card-title"> Reclamos pendientes de Evaluación</h4>
                                                <center>
                                                        ...
                                                        <table class="table table">
                                                            ...
                                                            <tbody id="tabla_reclamos">
                                                                ...
                                                                foreach ($lisMesa as $x) {
                                                                    ...
                                                                    if($x[2]=='5') $tipo="Otro";
                                                                    echo "<tr><td>R000$x[0]</td><td>$x[1]</td><td>$tipo</td><td>$x[3]</td><td><div class='form-check form-check-muted m-0'><input type='radio' name='optpedidos' Onclick='reclamo($x[0])' class='form-check-input'>Seleccionar</div></td></tr>";
                                                                }
                                                                ?>
                                                            </tbody>
                                                        </table>
                                                        <h5 style="margin: auto;">Detalle: </h5><br>
                                                        <textarea readonly id="coment" name="coment" rows="3" cols="80" placeholder="Escribe sobre el reclamo"></textarea>
                                                    </div><br><br>

                                                    <div class="card">
                                                        <div class="card-body">
                                                            <h4 class="card-title">EVALUACIÓN DE RECLAMO</h4><br>
                                                            <div class="form-group row">
                                                                <div class="col">
                                                                    <div class='form-check form-check-muted m-0'><input type='radio' name='optpedidos' Onclick='aprobar()' class='form-check-input'>Aprobar</div>
                                                                    <div class='form-check form-check-muted m-0'><input type='radio' name='optpedidos' Onclick='desaprobar()' class='form-check-input'>Desaprobado</div>
                                                                </div>
                                                                <div class="col">
                                                                    <h5 style="margin: auto;">Detalle de Evaluación: </h5><br>
                                                                    <textarea  id="comentario" name="comentarios" rows="5" cols="40" placeholder="Escribe sobre el reclamo"></textarea>
                                                                </div>
                                                            </div>

                                                            <center><button id="guardartodo" Onclick="evaluarreclamo()" class="btn btn-lg btn-primary btn-icon-text centrar">Generar Evaluacion de Reclamo
                                                            </button></center>
        ...
        <div class="modal-containerconfi" id="modal_containerconfi">
            <div class="modalconfi">
                ...
                <h1 class="whitemodal">¿Desea evaluar el Reclamo?</h1>
                <p class="whitemodal">
                    El reclamo se evaluará luego de dar click en el botón aceptar
                </p>
