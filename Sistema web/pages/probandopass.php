...
<html lang="es">
    ...
    <body>
                        ...
                        <div class="div__data">
                            ...
                            <div class="formulario__grupo" id="grupo__password">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="password" class="formulario__input heck-seguridad form-control input__login" name="password" id="password" id="pass1"placeholder="Ingresa tu nueva contraseña">
                            ...
                            <div class="formulario__grupo" id="grupo__password2">
                                ...
                                <div class="formulario__grupo-input">
                                    <input type="password" class="formulario__input check-seguridad form-control input__login" name="password2" id="password2" id="pass2" name="contraseña" placeholder="Ingresa tu nueva contraseña">
                                    <i class="formulario__validacion-estado fas fa-times-circle"></i>
                                </div>
        ...
        <script src="../js/formularioprueba.js"></script>
